...
namespace TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/TextMeshPro - Custom Input Field For Raft", 11)]
    public class CustomTMProInputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected CustomTMProInputField()
        { }
        ...
        public bool richText { get { return false; } set { m_RichText = value; SetTextComponentRichTextMode(); } }
        ...
        void SetTextComponentRichTextMode()
        {
            ...
            m_TextComponent.richText = false;
        }
