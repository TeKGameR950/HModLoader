...
public class CreateAssetBundles
{
    ...
    static void BuildAllAssetBundles()
    {
        ...
        try
        {
            ...
            File.Copy("D:\\HModLoader\\project\\UnityProject\\HModLoader\\Assets\\AssetBundles\\hml.assets", "D:\\HModLoader\\build\\scripts\\sotf\\hml.assets",true);
            File.Copy("D:\\HModLoader\\project\\UnityProject\\HModLoader\\Assets\\AssetBundles\\hml.assets", "C:\\Users\\TeKGameR\\AppData\\Roaming\\HModLoader\\data\\games\\sotf\\hml.assets", true);
            Debug.Log("<b>✔️ SUCCESSFULLY BUILDED ASSETBUNDLES & MOVED FILE ✔️</b>");
        }
        catch(Exception e)
        {
